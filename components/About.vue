<template>
  <div>
    <div class="2xl:max-w-[1320px] w-[95vw] mx-auto px-4">
        ...
        <div class="lg:col-span-6 col-span-full">
          <div>
            ...
            <p class="text-gray-500 font-medium text-base mb-10 leading-[1.75]">
              ...
              opportunities, and shared experiences. Together, we can achieve
              great things! #ConnectWithMe #ProfessionalNetworking"
            </p>
